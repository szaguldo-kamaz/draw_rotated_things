...
# this could also be just a draw_rotate_polygon wrapper...
#    polycoords=coord;
#    polycenter=( int((coord[0][0]+coord[1][0])/2), int((coord[0][1]+coord[1][1])/2) );
#    return draw_rotated_polygon(graph, polycoords, polycenter, angle, color, rotcentangle=rotcentangle, rotcentdist=rotcentdist, fill=False, linewidth=linewidth);
#
